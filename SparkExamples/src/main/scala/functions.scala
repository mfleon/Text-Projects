...
object functions {
  ...
  /**
    ...
    */
  @transient private var langDetector: LanguageDetector = _
  private def getOrCreateDetector(): LanguageDetector = {
  ...
  /**
    * Detect language using Tika
    */
  def language = udf { sentence: String =>
    getOrCreateDetector().detect(sentence).getLanguage
  }
